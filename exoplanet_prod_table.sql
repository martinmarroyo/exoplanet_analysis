CREATE TABLE IF NOT EXISTS exoplanet.exoplanet_data
(
    index bigint,
    planet_name text COLLATE pg_catalog."default" NOT NULL,
    planet_status text COLLATE pg_catalog."default" NOT NULL,
    ...
    CONSTRAINT exoplanet_data_pkey PRIMARY KEY (planet_name, planet_status, updated)
)
